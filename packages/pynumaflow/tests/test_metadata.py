...
class TestUserMetadata:
    ...
    def test_user_metadata_groups(self):
        """Test groups() method"""
        metadata = UserMetadata()
        metadata.add_key("group1", "key1", b"value1")
        metadata.add_key("group2", "key2", b"value2")
        groups = metadata.groups()
        assert len(groups) == 2
        assert "group1" in groups
        assert "group2" in groups
    ...
    def test_user_metadata_keys_existing_group(self):
        ...
        metadata = UserMetadata()
        metadata.add_key("group1", "key1", b"value1")
        metadata.add_key("group1", "key2", b"value2")
        keys = metadata.keys("group1")
    ...
    def test_user_metadata_keys_nonexistent_group(self):
        ...
        metadata = UserMetadata()
        metadata.add_key("group1", "key1", b"value1")
        assert metadata.keys("nonexistent") == []
    ...
    def test_user_metadata_len(self):
        ...
        metadata.add_key("group1", "key3", b"value3")
    ...
    def test_user_metadata_add_overwrites_existing_key(self):
        ...
        metadata = UserMetadata()
        metadata.add_key("group1", "key1", b"value1")
        metadata.add_key("group1", "key1", b"new_value")
    ...
    def test_user_metadata_remove_existing_key(self):
        ...
        metadata.add_key("group1", "key1", b"value1")
        metadata.add_key("group1", "key2", b"value2")
        removed_value = metadata.remove_key("group1", "key1")
    ...
    def test_user_metadata_remove_nonexistent_group(self):
        ...
        metadata = UserMetadata()
        metadata.add_key("group1", "key1", b"value1")
        removed_value = metadata.remove_key("nonexistent", "key1")
    ...
    def test_user_metadata_remove_nonexistent_key(self):
        ...
        metadata.add_key("group1", "key1", b"value1")
        metadata.add_key("group1", "key2", b"value2")
        removed_value = metadata.remove_key("group1", "nonexistent")
        assert removed_value is None
    ...
    def test_user_metadata_remove_nonexistent_both(self):
        ...
        metadata = UserMetadata()
        removed_value = metadata.remove_key("nonexistent", "nonexistent")
        assert removed_value is None
    ...
    def test_user_metadata_remove_group_existing(self):
        ...
        metadata.add_key("group1", "key1", b"value1")
        metadata.add_key("group1", "key2", b"value2")
        metadata.add_key("group2", "key3", b"value3")
    ...
    def test_user_metadata_clear(self):
        ...
        metadata.add_key("group1", "key1", b"value1")
        metadata.add_key("group2", "key2", b"value2")
        metadata.add_key("group3", "key3", b"value3")
    ...
    def test_user_metadata_complex_scenario(self):
        ...
        # Add multiple groups
        metadata.add_key("headers", "content-type", b"application/json")
        metadata.add_key("headers", "authorization", b"Bearer token123")
        metadata.add_key("metrics", "counter", b"42")
        metadata.add_key("metrics", "timestamp", b"1234567890")
        ...
        # Remove a key
        metadata.remove_key("headers", "authorization")
...
class TestUserMetadataEdgeCases:
    ...
    def test_empty_group_name(self):
        ...
        metadata = UserMetadata()
        metadata.add_key("", "key1", b"value1")
        assert "" in metadata
    ...
    def test_multiple_groups_with_same_keys(self):
        ...
        metadata = UserMetadata()
        metadata.add_key("group1", "key", b"value1")
        metadata.add_key("group2", "key", b"value2")
    ...
    def test_special_characters_in_names(self):
        ...
        metadata = UserMetadata()
        metadata.add_key("group-1", "key_1", b"value1")
        metadata.add_key("group.2", "key:2", b"value2")
        metadata.add_key("group@3", "key#3", b"value3")
        assert len(metadata) == 3
    ...
    def test_large_values(self):
        ...
        metadata.add_key("group1", "large_key", large_value)
    ...
    def test_many_groups(self):
        ...
        metadata = UserMetadata()
        for i in range(100):
            metadata.add_key(f"group{i}", f"key{i}", f"value{i}".encode())
    ...
    def test_many_keys_in_group(self):
        ...
        metadata = UserMetadata()
        for i in range(100):
            metadata.add_key("group1", f"key{i}", f"value{i}".encode())
