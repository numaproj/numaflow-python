...
class Reduce(object):
    ...
    def ReduceFn(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/reduce.v1.Reduce/ReduceFn',
    ...
    def IsReady(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/reduce.v1.Reduce/IsReady',
