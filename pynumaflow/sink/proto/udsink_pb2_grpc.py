...
def add_UserDefinedSinkServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'UserDefinedSink', rpc_method_handlers)
...
class UserDefinedSink(object):
    ...
    def SinkFn(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/UserDefinedSink/SinkFn',
    ...
    def IsReady(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/UserDefinedSink/IsReady',
