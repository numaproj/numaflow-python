...
class Source(object):
    ...
    def ReadFn(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/source.v1.Source/ReadFn',
    ...
    def AckFn(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/source.v1.Source/AckFn',
