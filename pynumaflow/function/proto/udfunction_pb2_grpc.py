...
class UserDefinedFunction(object):
    ...
    def MapFn(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/sample.UserDefinedFunction/MapFn',
    ...
    def MapTFn(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/sample.UserDefinedFunction/MapTFn',
            udfunction__pb2.Datum.SerializeToString,
            udfunction__pb2.DatumList.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ReduceFn(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/sample.UserDefinedFunction/ReduceFn',
            udfunction__pb2.Datum.SerializeToString,
            udfunction__pb2.DatumList.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def IsReady(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/sample.UserDefinedFunction/IsReady',
