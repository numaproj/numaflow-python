...
from pynumaflow.function import udfunction_pb2 as udfunction__pb2
...
class UserDefinedFunction(object):
    ...
    def ReduceFn(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/function.v1.UserDefinedFunction/ReduceFn',
            udfunction__pb2.Datum.SerializeToString,
            udfunction__pb2.DatumList.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
