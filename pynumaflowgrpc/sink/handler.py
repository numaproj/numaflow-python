...
from pynumaflowgrpc._tools import Singleton
from pynumaflowgrpc.decoder import NumaflowJSONDecoder, msgpack_decoder
from pynumaflowgrpc.exceptions import InvalidContentTypeError
from pynumaflowgrpc.sink._dtypes import Responses, Message
...
class HTTPSinkHandler(metaclass=Singleton):
    ...
    Example invocation:
    >>> from pynumaflowgrpc.sink import Responses, Response, Message
