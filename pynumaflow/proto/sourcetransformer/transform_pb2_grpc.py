...
class SourceTransform(object):
    ...
    @staticmethod
    def SourceTransformFn(request_iterator,
            target,
            options=(),
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/sourcetransformer.v1.SourceTransform/SourceTransformFn',
    ...
    def IsReady(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/sourcetransformer.v1.SourceTransform/IsReady',
